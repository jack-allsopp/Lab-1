...
mainLoop:
            ...
            LDAA  #$15        ; store the value 16 (the length of the string)
            STAA  string_length
...
THREEfirstLetter:                    ;Make the first Letter of each word uppercase
            CMPA #$15                ;Test if the count of the string length is at the start (very first letter)
